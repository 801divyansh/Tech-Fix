  ...
  return (
    ...
    >
      ...
      <header className="relative py-16 text-center z-10">
        ...
        >
          Comprehensive PC repair and maintenance services to keep your desktop running at peak performance.
        </motion.p>
      </header>
