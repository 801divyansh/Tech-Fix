  ...
  return (
    ...
    >
        ...
        {[...Array(5)].map((_, i) => (
          <motion.div
            ...
            className={`absolute rounded-full ${
              theme === 'dark'
                ? 'bg-gradient-to-r from-purple-500 to-blue-500 opacity-20'
      ...
      <header className="relative py-16 text-center z-10">
        ...
        >
          Expert software installation, updates, and troubleshooting services for all your devices.
        </motion.p>
      </header>
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          >
            <img
              src="/images/software-service.png"
          ...
          >
            ...
            <ul className="space-y-2">
              ...
              <li>✔ Troubleshooting software errors and crashes.</li>
              <li>✔ Virus and malware removal.</li>
              <li>✔ Software updates and optimization.</li>
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              ...
              <p className="mb-6">Basic software installation and updates.</p>
            ...
            >
              ...
              <p className="mb-6">Installation, updates, and troubleshooting.</p>
            ...
            >
              ...
              <p className="mb-6">
                Full software installation, updates, troubleshooting, and virus removal.
              </p>
